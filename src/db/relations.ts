...
import { reimbursementNotesInDtDwh, reimbursementItemsInDtDwh, mCategoryInDtDwh, mBankInDtDwh, mEmployeesInDtDwh, mCompanyInDtDwh, mEmploymentInDtDwh, mReligionInDtDwh, mRolesInDtDwh, mCompanyTypeInDtDwh } from "./schema";

export const reimbursementItemsInDtDwhRelations = relations(reimbursementItemsInDtDwh, ({one}) => ({
	reimbursementNotesInDtDwh: one(reimbursementNotesInDtDwh, {
		fields: [reimbursementItemsInDtDwh.inReimbursementNoteId],
		references: [reimbursementNotesInDtDwh.inReimbursementNoteId]
	}),
	mCategoryInDtDwh: one(mCategoryInDtDwh, {
		fields: [reimbursementItemsInDtDwh.inCategoryId],
		references: [mCategoryInDtDwh.inCategoryId]
	}),
}));

export const reimbursementNotesInDtDwhRelations = relations(reimbursementNotesInDtDwh, ({one, many}) => ({
...
export const mCategoryInDtDwhRelations = relations(mCategoryInDtDwh, ({many}) => ({
	reimbursementItemsInDtDwhs: many(reimbursementItemsInDtDwh),
}));

export const mEmployeesInDtDwhRelations = relations(mEmployeesInDtDwh, ({one}) => ({
	mBankInDtDwh: one(mBankInDtDwh, {
...
export const mCompanyInDtDwhRelations = relations(mCompanyInDtDwh, ({one, many}) => ({
	mEmployeesInDtDwhs: many(mEmployeesInDtDwh),
	reimbursementNotesInDtDwhs: many(reimbursementNotesInDtDwh),
...
export const mEmploymentInDtDwhRelations = relations(mEmploymentInDtDwh, ({many}) => ({
	mEmployeesInDtDwhs: many(mEmployeesInDtDwh),
}));

export const mReligionInDtDwhRelations = relations(mReligionInDtDwh, ({many}) => ({
	mEmployeesInDtDwhs: many(mEmployeesInDtDwh),
}));
...
export const mCompanyTypeInDtDwhRelations = relations(mCompanyTypeInDtDwh, ({many}) => ({
